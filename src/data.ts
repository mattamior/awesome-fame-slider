...
const standard = (surnameZh: string, surnameEn: string): Rank[] => [
  { id: 'delay', zh: `小难${surnameZh}`, en: `Delayed ${surnameEn}` },
  { id: 'jail', zh: `牢${surnameZh}`, en: `Jailed ${surnameEn}` },
  { id: 'guy', zh: `${surnameZh}子`, en: `${surnameEn}` },
  { id: 'saint', zh: `${surnameZh}圣`, en: `Saint ${surnameEn}` },
  { id: 'god', zh: `${surnameZh}神`, en: `God ${surnameEn}` },
  { id: 'ancestor', zh: `${surnameZh}祖`, en: `Ancestor ${surnameEn}` },
];
...
export const PEOPLE: Person[] = [
  { id:'liang', name:'Liang Wenfeng', nameZh:'梁文锋', role:'DeepSeek', accent:'梁', avatarIndex:0, avatarUrl:LIANG_RANK_IMAGES[2], rankImageUrls:LIANG_RANK_IMAGES, avatarSourceUrl:LIANG_MEME_SOURCE, ranks:standard('梁','Liang') },
  { id:'musk', name:'Elon Musk', nameZh:'马斯克', role:'xAI · Tesla · SpaceX', accent:'马', avatarIndex:1, avatarUrl:MUSK_RANK_IMAGES[2], rankImageUrls:MUSK_RANK_IMAGES, avatarSourceUrl:MUSK_MEME_SOURCE, ranks:standard('马','Musk') },
  { id:'altman', name:'Sam Altman', nameZh:'奥特曼', role:'OpenAI', accent:'奥', avatarIndex:2, avatarUrl:ALTMAN_RANK_IMAGES[2], rankImageUrls:ALTMAN_RANK_IMAGES, avatarSourceUrl:ALTMAN_MEME_SOURCE, ranks:standard('奥','Altman') },
  { id:'tibo', name:'Tibo Sottiaux', nameZh:'Tibo', role:'Codex', accent:'T', avatarIndex:3, avatarUrl:TIBO_RANK_IMAGES[2], rankImageUrls:TIBO_RANK_IMAGES, avatarSourceUrl:TIBO_MEME_SOURCE, ranks:standard('Tibo','Tibo') },
  { id:'huang', name:'Jensen Huang', nameZh:'黄仁勋', role:'NVIDIA', accent:'黄', avatarIndex:4, avatarUrl:HUANG_RANK_IMAGES[2], rankImageUrls:HUANG_RANK_IMAGES, avatarSourceUrl:HUANG_MEME_SOURCE, ranks:standard('黄','Huang') },
  { id:'zuck', name:'Mark Zuckerberg', nameZh:'扎克伯格', role:'Meta', accent:'扎', avatarIndex:5, avatarUrl:ZUCK_RANK_IMAGES[2], rankImageUrls:ZUCK_RANK_IMAGES, avatarSourceUrl:ZUCK_MEME_SOURCE, ranks:standard('扎','Zuck') },
  { id:'dario', name:'Dario Amodei', nameZh:'Dario', role:'Anthropic', accent:'D', avatarIndex:6, avatarUrl:DARIO_RANK_IMAGES[2], rankImageUrls:DARIO_RANK_IMAGES, avatarSourceUrl:DARIO_MEME_SOURCE, ranks:standard('Dario','Dario') },
  { id:'demis', name:'Demis Hassabis', nameZh:'哈萨比斯', role:'Google DeepMind', accent:'哈', avatarIndex:7, avatarUrl:DEMIS_RANK_IMAGES[2], rankImageUrls:DEMIS_RANK_IMAGES, avatarSourceUrl:DEMIS_IMAGE_SOURCE, ranks:standard('哈','Hassabis') },
];
